...
export const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-main-bg flex flex-col lg:flex-row text-text-primary">
      {/* Left Side: Auth Form */}
      <div className="lg:w-1/2 flex items-center justify-center p-8 bg-main-bg border-r border-white/5 order-2 lg:order-1">
      ...
      <div className="lg:w-1/2 flex flex-col justify-center px-8 lg:px-24 py-12 lg:py-0 order-1 lg:order-2">
        ...
        <p className="text-text-secondary text-lg mb-12 max-w-lg">
          Chat, manage tasks, write docs, and get AI insights — all in one place.
        </p>

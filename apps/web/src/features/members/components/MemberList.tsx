    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            className="w-80 rounded-lg border border-white/10 bg-surface-secondary/80 px-3 py-2 text-text-primary outline-none transition-colors placeholder:text-text-muted focus:border-primary-accent/40 focus:bg-surface-elevated"
          />
      ...
      <ul className="space-y-3">
        {workspaceMembers.map((m) => (
          <li
            key={m.user.id}
            className="flex items-center justify-between rounded-2xl border border-primary-accent/15 bg-surface-secondary/60 px-4 py-4 transition-all hover:-translate-y-px hover:border-primary-accent/40 hover:bg-primary-accent/5"
          >
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-primary-accent/15 bg-primary-accent/10 text-primary-accent font-semibold">
